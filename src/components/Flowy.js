...
function Flowy() {
        ...
        drag.innerHTML += `
          ...
          case 'whenAScorecardIsSubmitted':
            drag.innerHTML += `
              ...
              `
        break
      case 'thenAScorecardIsSubmitted':
        drag.innerHTML += `
            <div class='blockyleft'>
              <img src=${images['./logred.svg']} draggable="false" >
            ...
            <div class='blockyright'><img src=${images['./more.svg']}></div>
            <div class='blockydiv'></div>
            <div class='blockyinfo'>Edits and <span>deletes log entries</span> in this project</div>
          `
          break
          case 'nowAScorecardIsSubmitted':
            drag.innerHTML += `
                <div class='blockyleft'>
                  <img src=${images['./errorblue.svg']} draggable="false" >
                ...
                <div class='blockyright'><img src=${images['./more.svg']}></div>
                <div class='blockydiv'></div>
                <div class='blockyinfo'>Triggers a <span>specified</span> error</div>
              `
        break
        default:
          break;
  ...
  return <>
    <Navigation title="Content" onSave={() => {
